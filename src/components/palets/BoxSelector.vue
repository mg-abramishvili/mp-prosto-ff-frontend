<template>
    <div class="offcanvas offcanvas-end show" tabindex="-1" id="offcanvasBackdrop"
        ...
        <div class="offcanvas-header">
            <h5 id="offcanvasBackdropLabel" class="offcanvas-title">Добавить к палете</h5>
...
export default {
    ...
    methods: {
        loadBoxes() {
            ...
            axios
                .get(`${import.meta.env.VITE_API_FF_SERVER}/api/boxes-for-palet`)
                .then(response => {
                    if (response.data) {

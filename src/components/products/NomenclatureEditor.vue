    ...
    methods: {
        ...
        save() {
            ...
            axios({
                ...
                url: this.nomenclature ? `${import.meta.env.VITE_API_SERVER}/api/nomenclature/${this.nomenclature.uuid}/update` : `${import.meta.env.VITE_API_SERVER}/api/ff-nomenclatures`,
                data: {
